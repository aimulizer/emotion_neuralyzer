...
def add_songs():
    ...
    songs=songs[:5]
    # s1=songs[0]
    s1 = songs[0].replace("/home/aimulizer/Desktop/mp3/songs/","")
    s1 = s1.replace(".wav","")
    song1 = Button(songs_dialog,text=s1,fg='green',bg='black',activebackground='gray',activeforeground='black',command= lambda:  [song_to_song_box(songs[0]),songs_dialog.destroy()])
    # s2=songs[1]
    s2 = songs[1].replace("/home/aimulizer/Desktop/mp3/songs/","")
    s2 = s2.replace(".wav","")
    song2 = Button(songs_dialog,text=s2,fg='green',bg='black',activebackground='gray',activeforeground='black',command= lambda:  [song_to_song_box(songs[1]),songs_dialog.destroy()])
    # s3= songs[2]
    s3 = songs[2].replace("/home/aimulizer/Desktop/mp3/songs/","")
    s3 = s3.replace(".wav","")
    song3 = Button(songs_dialog,text=s3,fg='green',bg='black',activebackground='gray',activeforeground='black',command= lambda:  [song_to_song_box(songs[2]),songs_dialog.destroy()])
    # s4 = songs[3]
    s4 = songs[3].replace("/home/aimulizer/Desktop/mp3/songs/","")
    s4 = s4.replace(".wav","")
    song4 = Button(songs_dialog,text=s4,fg='green',bg='black',activebackground='gray',activeforeground='black',command= lambda:  [song_to_song_box(songs[3]),songs_dialog.destroy()])
    # s5=songs[4]
    s5 = songs[4].replace("/home/aimulizer/Desktop/mp3/songs/","")
    s5 = s5.replace(".wav","")
    song5 = Button(songs_dialog,text=s5,fg='green',bg='black',activebackground='gray',activeforeground='black',command= lambda:  [song_to_song_box(songs[4]),songs_dialog.destroy()])
